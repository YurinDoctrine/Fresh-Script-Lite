...
function Performance {
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\.NETFramework" -Name "OnlyUseLatestCLR" -Type DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SOFTWARE\Wow6432Node\Microsoft\.NETFramework" -Name "OnlyUseLatestCLR" -Type DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" -Name "RmGpsPsEnablePerCpuCoreDpc" -Type DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" -Name "LOWLATENCY" -Type DWord -Value 1 -Force
    ...
    New-ItemProperty -Path HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize -Name EnableBlurBehind -PropertyType DWord -Value 0 -Force
    ...
    New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name NoNetCrawling -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name ListviewWatermark -PropertyType DWord -Value 0 -Force
    ...
    New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name EnabledState -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name LoosenRudeAppCheck -PropertyType DWord -Value 0 -Force
    New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name StartMenuInit -PropertyType DWord -Value 2 -Force
    New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name ClassicViewState -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKCU:\Control Panel\Desktop" -Name MenuShowDelay -PropertyType String -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\CrashControl" -Name "AlwaysKeepMemoryDump" -PropertyType DWord -Value 0 -Force
    New-ItemProperty -Path "HKLM:\HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\CrashControl" -Name "AutoReboot" -PropertyType DWord -Value 0 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" -Name "SystemCacheDirtyPageThreshold" -PropertyType DWord -Value "0" -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" -Name "PoolUsageMaximum" -PropertyType DWord -Value "0" -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" -Name "PagedPoolQuota" -PropertyType DWord -Value "0" -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" -Name "NonPagedPoolQuota" -PropertyType DWord -Value "0" -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" -Name IdealNodeRandomized -Type "DWORD" -Value "0" -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" -Name AlwaysTrackIoBoosting -Type "DWORD" -Value "0" -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\DirectDraw" -Name "EmulationOnly" -PropertyType DWord -Value 0 -Force
    New-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Avalon.Graphics" -Name "DisableHWAcceleration" -PropertyType DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Perflib" -Name "Disable Performance Counters" -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\FTH" -Name "Enabled" -Type DWord -Value 0 -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" -Name "DisableStartupSound" -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\QoS" -Name "EnablePriorityBoost" -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\IO\None" -Name "IOBandwidth" -PropertyType DWord -Value 0 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "Latency" -PropertyType DWord -Value 0 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "LowLatencyScalingPercentage" -PropertyType DWord -Value 100 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "LatencyToleranceDefault" -PropertyType DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "LatencyToleranceVSyncEnabled" -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "EnergyEstimationEnabled" -PropertyType DWord -Value 0 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "CoreParkingDisabled" -PropertyType DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "EventProcessorEnabled" -PropertyType DWord -Value 0 -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore" -Name "DisableStoreApps " -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\CredentialGuard" -Name "Enabled" -Type DWord -Value 0 -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Signature Updates" -Name "ForceUpdateFromMU" -Type DWord -Value 0 -Force
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Signature Updates" -Name "RealtimeSignatureDelivery" -Type DWord -Value 0 -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\EdgeUI" -Name "TurnOffBackstack" -Type DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" -Name "TurnOffSPIAnimations" -Type DWord -Value 1 -Force

    if (!(Test-Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer")) {
        New-Item -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Force
    }
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Name "NoHeapTerminationOnCorruption" -Type DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Name "NoDataExecutionPrevention" -Type DWord -Value 1 -Force

    if (!(Test-Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\SoftwareProtectionPlatform")) {
        New-Item -Force "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\SoftwareProtectionPlatform"
    }
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\SoftwareProtectionPlatform" -Name "Activation" -PropertyType DWord -Value 0 -Force

    if (!(Test-Path "HKLM:\SOFTWARE\SOFTWARE\Microsoft\Input\Buttons")) {
        New-Item -Force "HKLM:\SOFTWARE\SOFTWARE\Microsoft\Input\Buttons"
    }
    New-ItemProperty -Path "HKLM:\SOFTWARE\SOFTWARE\Microsoft\Input\Buttons" -Name HardwareButtonsAsVKeys -PropertyType DWord -Value 0 -Force
    ...
    Get-ChildItem -Path "HKLM:\SYSTEM\CurrentControlSet\Control\WMI\AutoLogger" -Recurse | ForEach-Object {
        New-ItemProperty -Path $_.PSPath -Name "Start" -Value 0 -PropertyType DWORD -Force
    }
    ...
    auditpol /set /subcategory:"System Integrity" /failure:disable
    auditpol /set /subcategory:"Other System Events" /success:disable
    auditpol /set /subcategory:"Other System Events" /failure:disable
    ...
    auditpol /set /subcategory:"Security State Change" /failure:disable
...
function Processor {
    ...
    powercfg -setDCvalueindex SCHEME_CURRENT SUB_PROCESSOR LATENCYHINTPERF1 0
